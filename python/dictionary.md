...
> Для поиска конкретного термина можно воспользоваться сочетанием клавиш Ctrl+F.
> С мобильных устройств можно воспользоваться функцией «Найти на странице». В Safari нужно нажать на значок «Поделиться». В Chrome на Android или iOS ищем три вертикальные точки в правом верхнем углу или три горизонтальные точки в правом нижнем углу.
