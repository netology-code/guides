# Активация купона на учебную лицензию Jetbrains
...
## Продукты JetBrains:
Продукты JetBrains используют студенты шести профессий. Мы показали процесс активации учебной лицензии на примере установки продукта Goland для Golang-разработчиков. Если вы не Golang-разработчик, в шаге 1 и 10 выберите необходимый вам продукт.
