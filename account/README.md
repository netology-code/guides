...
## **ВЫПОЛНЕНИЕ ЗАДАНИЙ**
Когда вы в первый раз откроете страницу с домашним заданием вы увидите заставку ![Домашнее задание](account_img/homework_start_screen.jpg) с указанным сроком на выполнение домашнего задания. После того как вы нажмете на кнопку «Выполнить задание» счетчик начнет отсчитывать указанное время и вы перейдете на следующую страницу.
...
![Необходимо выполнить](account_img/homework_active_screen.jpg)
...
![Дополнительные материалы](account_img/account-homework-compliting-1.png)
...
![Дополнительные материалы](account_img/prezentation_screen.jpg)
...
![Дипломная работа](account_img/account-diplom.png)
...
Если вы не нашли ответ на свой вопрос, вы всегда можете связаться с координатором курса. Для этого нажмите на значок чата который находится в правом нижнем углу экрана.
...
![Связь с координатором](account_img/coordinator_connect.png)
